...
namespace ConsoleCargaDatosDNK.Modelos
{
    ...
    public partial class ContratoMantenimientoEntities : DbContext
    {
        public ContratoMantenimientoEntities()
            : base("name=ContratoMantenimientoEntities")
        {
        }
        ...
        public virtual DbSet<InsumosST> InsumosST { get; set; }
