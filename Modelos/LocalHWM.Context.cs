...
namespace ConsoleCargaDatosDNK.Modelos
{
    ...
    public partial class LocalHWMEntities : DbContext
    {
        public LocalHWMEntities()
            : base("name=LocalHWMEntities")
        {
        }
        ...
        [DbFunction("LocalHWMEntities", "fnGetAccountIDAndDescendents")]
        public virtual IQueryable<fnGetAccountIDAndDescendents_Result> fnGetAccountIDAndDescendents(Nullable<int> accountId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fnGetAccountIDAndDescendents_Result>("[LocalHWMEntities].[fnGetAccountIDAndDescendents](@accountId)", accountIdParameter);
        }
    
        [DbFunction("LocalHWMEntities", "fnGetAccountIDsforDescendents")]
        public virtual IQueryable<fnGetAccountIDsforDescendents_Result> fnGetAccountIDsforDescendents(Nullable<int> accountId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fnGetAccountIDsforDescendents_Result>("[LocalHWMEntities].[fnGetAccountIDsforDescendents](@accountId)", accountIdParameter);
        }
    
        [DbFunction("LocalHWMEntities", "fnGetAccountImmediateDescendantsByID")]
        public virtual IQueryable<fnGetAccountImmediateDescendantsByID_Result> fnGetAccountImmediateDescendantsByID(Nullable<int> accountId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fnGetAccountImmediateDescendantsByID_Result>("[LocalHWMEntities].[fnGetAccountImmediateDescendantsByID](@accountId)", accountIdParameter);
        }
    
        [DbFunction("LocalHWMEntities", "intlist_to_tbl")]
        public virtual IQueryable<intlist_to_tbl_Result> intlist_to_tbl(string list)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<intlist_to_tbl_Result>("[LocalHWMEntities].[intlist_to_tbl](@list)", listParameter);
        }
    
        [DbFunction("LocalHWMEntities", "SplitString")]
        public virtual IQueryable<SplitString_Result> SplitString(string stringToSplit)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitString_Result>("[LocalHWMEntities].[SplitString](@stringToSplit)", stringToSplitParameter);
        }
    
        [DbFunction("LocalHWMEntities", "StringToArray")]
        public virtual IQueryable<StringToArray_Result> StringToArray(string inStr)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<StringToArray_Result>("[LocalHWMEntities].[StringToArray](@InStr)", inStrParameter);
        }
